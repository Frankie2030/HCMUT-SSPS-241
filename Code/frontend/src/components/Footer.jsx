...
//             <Typography
//               as="a"
//               href="https://github.com/Frankie2030/HCMUT-SSPS-241"
//               color="white"
...
const Footer = () => {
  return (
    <footer className="relative w-full bg-blue-fill bg-cover py-8">
      <div className="mx-auto w-full max-w-7xl px-4">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="flex flex-col items-center text-center md:items-start md:text-left">
            ...
            <div>
              <Typography color="white" className="mb-1 text-sm md:text-base">
                Ly Thuong Kiet Campus: 268 Ly Thuong Kiet, Ward 14, District 10,
                Ho Chi Minh City
              </Typography>
              <Typography color="white" className="text-sm md:text-base">
                Di An Campus: Tan Lap Quarter, Dong Hoa Ward, Di An City, Binh
                Duong Province
              </Typography>
            </div>
          ...
          <div className="text-center md:text-left">
            {LINKS.map(({ title, items }) => (
              <ul key={title} className="ps-0 md:ps-5">
                <Typography
                  variant="small"
                  color="white"
                  className="my-3 font-medium opacity-50"
                ...
                {items.map((link) => (
                  <li key={link}>
                    <Typography
                      ...
                      href="#"
                      color="white"
                      className="block py-1 text-sm font-normal transition-colors hover:text-blue-gray-900"
                    >
                      {link}
                    </Typography>
                  </li>
        ...
        {/* Bottom Section */}
        <div className="mt-8 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 pt-4 text-center md:flex-row md:justify-between">
          <Typography
            variant="small"
            color="white"
            className="mb-4 font-normal md:mb-0"
          >
            &copy; {currentYear} Ho Chi Minh City University of Technology -
          ...
          <div className="flex gap-4 text-blue-gray-900">
            ...
            {/* Additional Icons */}
            {/* You can add more social media icons here following the same pattern as above. */}
            <Typography
              as="a"
              href="https://github.com/Frankie2030/HCMUT-SSPS-241"
              color="white"
